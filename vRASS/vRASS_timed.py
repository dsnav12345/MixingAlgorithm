...
# Storing answers to print at end of completion
Ans = math.inf
n_m = 0
n_i = 0
n_w = 0
...
# Function to end the program and output the result after completion of time limit
...
# To calculate cost function of a given solution
...
# Manual input
# inp = [m, d, r, concentrations, costs, target concentration, m^d]
...
# Checking satisfiability of hRASS by availability constraint
for r in range(R):
...
# Calculating cost to each solution and picking best solution among them
idx = 1
